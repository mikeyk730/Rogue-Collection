...
#define MDK_LOG(...)                  if (g_game_log) fprintf(g_game_log, __VA_ARGS__) && fflush(g_game_log)
...
#if defined(ROGUE_5_2_1) || defined(ROGUE_5_4_2) || defined(ROGUE_5_3) || defined(ROGOMATIC)
