...
int gotoinit(void);
int followmap(const char* why, register int movetype);
int darkroom(void);
int aftermelee(void);
int archery(void);
...
void fmove(const char* desc, int d);
void move1(const char* desc, int d);
void mmove(const char* desc, int d, int mode);
...
int battlestations(int m, char *monster, int mbad, int danger, int mdir, int step_turns, int zap_dist, int monster_state, int adj);
