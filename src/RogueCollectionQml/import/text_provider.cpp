...
Coord TextProvider::TileSize() const
{
...
std::unique_ptr<ITileProvider> CreateTextProvider(FontConfig* font_cfg, TextConfig* text_cfg, SDL_Renderer* renderer)
{
    std::unique_ptr<ITileProvider> p;
