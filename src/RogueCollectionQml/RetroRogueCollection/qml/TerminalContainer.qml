...
ShaderTerminal{
    ...
    property int naturalWidth: terminal.naturalWidth + frame.displacementLeft + frame.displacementRight
    property int naturalHeight: terminal.naturalHeight + frame.displacementTop + frame.displacementBottom
